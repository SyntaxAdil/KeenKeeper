...
const FriendsCard = ({ friend }) => {
  ...
  return (
    <div className="p-8 rounded-md shadow flex items-center  flex-col transition-all duration-150 hover:scale-105 hover:border-[#cbfadb] border border-white text-center">
      <Image
        src={friend.picture}
        width={80}
        height={80}
